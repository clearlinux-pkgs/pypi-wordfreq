...
Source0  : https://files.pythonhosted.org/packages/44/68/a01766c34df06db339dbc3e50c6f436b91790ca66a049e771064bcc5e346/wordfreq-3.0.2.tar.gz
...
%prep
%setup -q -n wordfreq-3.0.2
cd %{_builddir}/wordfreq-3.0.2
pushd ..
cp -a wordfreq-3.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664289417
